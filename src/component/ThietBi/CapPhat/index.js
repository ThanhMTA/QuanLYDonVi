        ...
        <>
            ...
            >
                ...
                <Content
                    ...
                    {/* title  */}
                    <Layout>
                        <Title level={2} align="middle"> Cấp Phát Thiết Bị</Title>
                    </Layout>
                    {/* form  */}
                    <Layout
                        style={{
                        ...
                        <Row align="middle">
                            <Col span={8} style={{ paddingRight: ' 10px' }} >
                                ...
                                >
                                    ...
                                    <Form.Item label="Loại Thiết Bị" name="loai" rules={[{ required: true }]}>
                                        <Input />
                                    </Form.Item>
                                    <Form.Item label="Thiết Bị" name="loai" rules={[{ required: true }]}>
                                        <Input />
                                    </Form.Item>
                            ...
                            <Col span={8} style={{ padding: '0 5px' }} >
                                ...
                                >
                                    <Form.Item label="Tình Trạng" name="loai" rules={[{ required: true }]}>
                                        <Input />
                                    </Form.Item>
                                    <Form.Item label="Số Lượng" name="loai" rules={[{ required: true }]}>
                                        <Input />
                                    </Form.Item>
                                </Form>
                            ...
                            <Col span={8} style={{ paddingLeft: ' 10px' }}>
                                ...
                                >
                                    ...
                                    <Form.Item label="Thời Gian" name="DonVi" rules={[{ required: true }]}>
                                        <Input />
                                    </Form.Item>
                        ...
                        <Content>
                            <Row>
                                <Col span={12} style={{ paddingRight: ' 10px' }}>
                                    ...
                                    <Title level={3} align="middle"> Danh sách cấp phát </Title>
                                ...
                                <Col span={12} style={{ paddingLeft: ' 10px' }} >
                                    <Title level={3} align="middle"> Thông tin chi tiết  </Title>
